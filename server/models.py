...
class User(db.Model, SerializerMixin):
    ...
    serialize_rules = ('-password_hash', '-verification_code','-projects',)
...
class Project(db.Model, SerializerMixin):
    ...
    #serialize
    serialize_rules = ('-owner.projects', '-members.project', '-cohort.projects', '-members.cohort', '-project_members.project')
